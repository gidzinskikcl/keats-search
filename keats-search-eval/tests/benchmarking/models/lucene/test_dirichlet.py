...
def test_search(sample_query, sample_java_output, expected):
    engine = dirichlet.DirichletSearchEngine(doc_path="dummy/path/to/documents.json", k=5)
    ...
    with patch("subprocess.run") as mock_run:
        ...
        mock_run.assert_called_with(
            [
                "java",
                "-jar", "search_engines/lucene-search/target/dirichlet-search-jar-with-dependencies.jar",
