...
def test_add_and_get(tmp_path):
    ...
    gateway = csv_query_gateway.CSVQueryGateway(temp_csv_file)
    ...
    test_data = [
        ...
        },
        {
            ...
            "doc_id": "12346",
            "type": "lecture",
            "url": "http://example.com/lecture2",
        },
        {
            "question": "What is a compiler?",
            "label": "basic",
            "answer": "A program that translates code from one language to another.",
            "course_name": "CS101",
            "lecture_title": "Programming Languages",
            "doc_id": "12347",
            "type": "lecture",
            "url": "http://example.com/lecture3",
        },
    ]
