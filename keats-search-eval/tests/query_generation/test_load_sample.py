...
def test_sample(pdf_segments, srt_segments, expected_output):
    with patch("query_generation.benchmarking.load_sample.random.sample", side_effect=[[pdf_segments[0]], [srt_segments[1], srt_segments[2]]]):
        observed = load_sample.sample(pdf_segments, srt_segments, pdf_count=1, srt_count=2)
