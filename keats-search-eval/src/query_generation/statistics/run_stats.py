...
def main():
    ...
    print(
        f"Excluded as empty/image-only: {n_excluded_pre} ({n_excluded_pre / total_queries:.2%})"
    )
    print(
        f"Excluded as invalid/administrative: {n_excluded_other} ({n_excluded_other / total_queries:.2%})"
    )
    print(
